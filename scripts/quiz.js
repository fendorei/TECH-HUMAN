...
function showAdvice() {
  ...
  switch (true) {
    case (score < 20):
      ...
      document.getElementById("advice-img1").src = "../images/quiz12.png"
      ...
      document.getElementById("advice-img2").src = "../images/quiz13.png"
    ...
    case (score >= 20 && score < 40):
      ...
      document.getElementById("advice-img3").src = "../images/quiz14.png"
      document.getElementsByClassName("advice4")[0].style.display = "none";
      document.getElementsByTagName("hr")[3].style.display = "none";
      break;
    case (score >= 40 && score < 60):
